...
default_bad_words = [
    ...
    'Sht', 'Shyt', 'Shyte', 'Shytty', 'Skanky', 'Slutty', 'ahole', 'amcik', 'andskota',
    'anus', 'arschloch', 'arse', 'ash0le', 'ash0les', 'asholes', 'ass', 'assh0le', 'assh0lez',
    'asshole', 'assholes', 'assholz', 'assrammer', 'asswipe', 'ayir', 'azzhole', 'b00bs', 'b17ch',
    'b1tch', 'bassterds', 'bastard', 'bastards', 'bastardz', 'basterds', 'basterdz', 'bch', 'bi7ch',
    'bich', 'bitch', 'bitches', 'blowjob', 'boffing', 'boiolas', 'bollock', 'boobs', 'breasts',
    'btch', 'buceta', 'bullshit', 'butthole', 'buttpirate', 'buttwipe', 'c0ck', 'c0cks', 'c0k',
    'cabron', 'cawk', 'cawks', 'cazzo', 'chink', 'chraa', 'chuj', 'cipa', 'clit', 'clits', 'cnts',
    'cntz', 'cock', 'cockhead', 'cocks', 'cocksucker', 'crap', 'cum', 'cunt', 'cunts', 'cuntz',
    'd4mn', 'damn', 'daygo', 'dego', 'dick', 'dike', 'dild0', 'dild0s', 'dildo', 'dildos', 'dilld0',
    'dilld0s', 'dirsa', 'dominatricks', 'dominatrics', 'dominatrix', 'dupa', 'dyke', 'dziwka',
    'ejackulate', 'ejakulate', 'enculer', 'enema', 'faen', 'fag', 'fag1t', 'faget', 'fagg1t',
    ...
    'mouliewop', 'muie', 'mulkku', 'muschi', 'mutha', 'n1gr', 'nastt', 'nasty', 'nazi', 'nazis',
    'nepesaurio', 'nigga', 'niggas', 'nigger', 'nigur', 'niiger', 'niigr', 'nutsack', 'orafis',
    'orgasim', 'orgasm', 'orgasum', 'oriface', 'orifice', 'orifiss', 'orospu', 'p0rn', 'packi',
    'packie', 'packy', 'paki', 'pakie', 'paky', 'paska', 'pecker', 'peeenus', 'peeenusss', 'peenus',
