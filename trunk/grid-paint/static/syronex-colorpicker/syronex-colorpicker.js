...
(function($) {
  var methods = {
    ...
    colors: function() {
      var $this = $(this);
      var colorDivs=$this.find(".jColorSelect > div")
      var result=[];
      for (var i=0; i<colorDivs.length; i++) {
      	result.push(rgb2hex($(colorDivs[i]).css("background-color")))
      };
      return result;
    }
  ...
  $.fn.colorPalette = function(method) {
    if ( methods[method] ) {
      return methods[ method ].apply( this, Array.prototype.slice.call( arguments, 1 ));
    } else if ( typeof method === 'object' || ! method ) {
      return methods.init.apply( this, arguments );
    } else {
      $.error( 'Method ' +  method + ' is not supported for jQuery.colorPalette' );
    } 
  };
})(jQuery);
